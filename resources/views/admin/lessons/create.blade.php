          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Создание секции или кружка</h3>                
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
              <form class="p-3" action="{{ route('lesson.store') }}" method="POST">
                    @csrf
                      <div class="form-group">
                        <label for="">Наименование</label>
                        <input type="text" class="form-control" placeholder="Введите название секции или кружка">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Введите описание кружка"></textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="1" placeholder="Введите  руководителя"></textarea>
                      </div>
                      <div class="form-group">
